...
approach of Shahriar et al.~\cite{shahriar2024}, while avoiding the
strict-precedence starvation failure mode discussed by Gorkemli et
al.~\cite{gorkemli2015}.
...
duration). The first five features follow the classification pipeline of
...
traffic without deep packet inspection. The sixth feature, byte rate,
